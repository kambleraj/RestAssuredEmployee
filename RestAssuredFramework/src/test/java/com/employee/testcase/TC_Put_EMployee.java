...
public class TC_Put_EMployee extends TestBase {
	...
	public void createEmployee() throws InterruptedException
	{
		...
		logger.info("------put employe started---");
	...
	//...other verification point like content type, status code-200, status line or time
